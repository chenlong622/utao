...
> ⚠️ **重要说明：** 各大平台视频播放与任意网站浏览，需配合 [土拨鼠遥控](https://www.vonchange.com) 中的**浏览器遥控**使用。
...
**电视端 · 免费直播** — 电视直播一目了然  
央视、卫视与地方台分类清晰，遥控器点选切台；大屏直接播，适合客厅长时间观看。

![电视直播](img/01.jpeg)

**手机端 · 土拨鼠遥控 · 浏览器遥控**

1. **浏览器遥控入口** — 一键进入腾讯视频、爱奇艺、芒果、B站等平台，也可搜索任意网站。  
   ![浏览器遥控入口](img/02.jpeg)

2. **平台片库浏览** — 在手机端浏览热门、最新与分类内容，点选后大屏浏览器打开对应页面。  
   ![平台片库浏览](img/03.jpeg)

3. **播放遥控** — 选集、进度、音量与全屏均可在手机操控；搭配飞鼠触控更顺手。  
   ![播放遥控](img/04.jpeg)
